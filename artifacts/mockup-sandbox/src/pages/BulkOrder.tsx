...
import { submitBulkOrder } from "../lib/api";
...
export default function BulkOrder({ cart, onUpdateQty, onRemove, onClearCart }: BulkOrderProps) {
  ...
  const minDate = minPickupDate.toISOString().split("T")[0];
    ...
    <div className="min-h-screen bg-[#FFF8F0]">
      ...
      <div className="bg-[#2C1810] pt-24 pb-12 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-white/60 max-w-lg mx-auto text-sm sm:text-base">
          Ordering for a team, office, or event? Schedule your pickup and we'll
          have everything ready fresh on the day.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm overflow-hidden sticky top-20">
              <div className="px-5 py-4 border-b border-[#F5E6C8] flex items-center justify-between">
                <div>
                  <h2 className="font-bold text-[#2C1810]" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Order Summary
                  </h2>
              ...
              {cart.length === 0 ? (
                <div className="px-5 py-12 text-center">
                  ...
                  <p className="text-xs text-[#2C1810]/30 mt-1">Go to the menu to add items.</p>
                </div>
              ) : (
                <>
                      ...
                      <div key={item.id} className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          <button
                            ...
                            className="w-6 h-6 rounded-md bg-[#FFF8F0] flex items-center justify-center hover:bg-[#D4A017] hover:text-white transition-colors border border-[#D4A017]/20"
                          >
                            <Minus size={11} />
                          </button>
                          ...
                          <button
                            ...
                            className="w-6 h-6 ml-0.5 flex items-center justify-center text-[#2C1810]/30 hover:text-red-500 transition-colors"
                          >
                            <Trash2 size={12} />
                          </button>
                        </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-sm p-6">
              <h2 className="font-bold text-[#2C1810] text-xl mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                Your Details
              </h2>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Dietary restrictions, packaging preferences, delivery notes…"
